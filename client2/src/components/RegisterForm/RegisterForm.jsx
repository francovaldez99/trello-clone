  ...
  const handleSubmit = (event) => {
   ...
   if(Object.values(formRegister).every((el)=>!!el)){
    if(formRegister.password === formRegister.password_confirmation){
      ...
      .catch((err) => {
        console.log("🚀 ~ file: RegisterForm.jsx:14 ~ handleSubmit ~ err:", err)
            ...
            <form onSubmit={(event)=>handleSubmit(event)} className="mt-8 grid grid-cols-6 gap-6">
              ...
              <div className="col-span-6 sm:col-span-3">
                ...
                <input
                  ...
                  className={`mt-1 w-full rounded-md  ${formRegister.password_confirmation!="" && formRegister.password!==formRegister.password_confirmation?"bg-red-300":"border-gray-200" }  text-sm text-gray-700 shadow-sm`}
